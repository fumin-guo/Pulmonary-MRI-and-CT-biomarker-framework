...
img1 = metaImageRead([sub '/CT_exp.mhd']);
img1_hdr = metaImageInfo([sub '/CT_exp.mhd']);
img1 = double(img1);
img1 = (img1 - min(img1(:)))/(max(img1(:)) - min(img1(:)))*100;


img2 = metaImageRead([sub1 '/CT_insp.mhd']);
img2 = double(img2);
img2_orig = img2 ;
...
metaImageWrite(g2_def,[sub '/CT_insp_def.mhd'],img1_hdr);
